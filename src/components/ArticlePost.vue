<template>
  <article ref="article">
    ...
    <p>
      ...
      5:18, Col 1:1922, Romans 5:10 Salvation breach the gap/ separation sin
      caused, and it brings us to our rightful place in Christ with GOD.
    </p>

    <h2>What then is SIN?</h2>
    <p>
      Sin is a willing disobedience to the will of GOD. Sin is going against
      God’s commandment, and this have great consequences which includes
      spiritual death Romans 6: 23, separation from God.
      <br />
      Isaiah 59:. But your iniquities have separated between you and your God,
      and your sins have hid his face from you, that he will not hear.
      Fellowship and communion was lost Gen 3:8. Finally the dominion we once
      had over all things was rolled over to the devil Luke 4:6
    </p>

    <h2>Where did sin originate from?</h2>
    <p>
      Adam (the first man) was the pioneer of sin Romans 5:12,14. He and eve
    ...
    <p>
      ...
      The Rev 3:16, Romans 5:8, 3-5, matt 1: 21, Rom. 8:30, 2Cor 5:17-18, 1tim
      1:15, 1thes 1: 10, 2corinthians 5:21,’ for He had made him to be sin for
      us, who knew no sin; that we might be made the righteousness of God in him
      2Peter4:5.’
    </p>
    <h2>Related Scriptures</h2>
    <p>Romans 5, Romans 3 & 4, Romans 2:3-5, II Corinthians 3:18</p>
  </article>
</template>
...
const props = defineProps(["popup", "version", "theme", 'new']);

const article = ref(null);

onMounted(() => {
  window[props.new] = new BibleUp(article.value, {
    version: props.version,
    popup: props.popup,
    darkTheme: props.theme == 'light' ? false : true,
  });

  window[props.new].create();
