...
export let generated = computed(() => {
    ...
    let styleProps = {primary: opt.primary, secondary: opt.secondary, tertiary: opt.tertiary, headerColor: opt.headerColor, borderRadius: opt.borderRadius, boxShadow: opt.boxShadow, fontSize: opt.fontSize}
    ...
    // check others
    if (opt.bu_allow && opt.bu_allow !== 'false') {copy.bu_allow = opt.bu_allow}
    if (opt.bu_ignore && opt.bu_ignore !== 'false') {copy.bu_ignore = opt.bu_ignore}
